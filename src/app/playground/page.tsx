	...
	return (
		...
		<main className="h-screen w-screen relative">
			...
			<div className="w-full h-full z-0">
				{/* <button onClick={() => handleIntensityChange(Math.random())}>Change Rain Intensity</button> */}
				<Canvas>
					<directionalLight ref={directionalLightRef} position={[0, 20, -30]} intensity={1} color={"white"} castShadow />
					{/* <pointLight
		      ref={pointLightRef}
		      position={[0, 20, -30]}
		      intensity={200}
		      ...
		      castShadow
		    /> */}
					<pointLight ref={pointLightRef} position={[0, 5, 0]} intensity={20} color={"white"} castShadow />
